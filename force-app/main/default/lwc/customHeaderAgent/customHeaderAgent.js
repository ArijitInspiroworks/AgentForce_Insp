...
import logo from '@salesforce/resourceUrl/AASW_Favicon';
import icon from '@salesforce/resourceUrl/aaswIcon';

const SLDS_MENU_SELECTOR = "slds-dropdown-trigger slds-dropdown-trigger_click";

export default class CustomHeaderAgent extends LightningElement {
    logoUrl = logo;
    iconUrl = icon
     /**
